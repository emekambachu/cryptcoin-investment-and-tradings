...
<head>
    ...
    <meta name="viewport" content="{{ env('APP_NAME') }}">
        ...
        <div class="uk-container uk-text-small">
            ...
            <div class="uk-grid uk-margin-large-top">
                <div class="uk-width-1-1">
                    <p class="uk-heading-line uk-margin-large-bottom"><span>Copyright © 2021 Cryptcoin Investment and Tradings. All Rights Reserved.</span></p>
