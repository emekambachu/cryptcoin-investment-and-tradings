                    ...
                    <div class="uk-grid uk-flex-center">
                        <div class="uk-width-3-5@m">
                            <div class="in-padding-horizontal@s">
                                ...
                                <!-- logo end -->
                                <p class="uk-text-lead uk-margin-top uk-margin-remove-bottom">Recover your password</p>
                                ...
                                <!-- login form begin -->
                                <form class="uk-grid uk-form" action="{{ route('recover-password') }}" method="post">
                                    @csrf
                                    <label>Email</label>
                                    ...
                                    <div class="uk-margin-small uk-width-1-1">
                                        <button class="uk-button uk-width-1-1 uk-button-primary uk-border-rounded uk-float-left" type="submit" name="submit">Recover Password</button>
                                    </div>
                                </form>
                                <!-- login form end -->
                                <div class="uk-margin-medium-bottom uk-text-center">
                                    ...
                                    <a class="" href="{{ route('login') }}"><i class="uk-margin-small-right"></i>Login</a>
                                </div>
                            </div>
                        </div>
                    </div>
